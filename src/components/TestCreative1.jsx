...
const TestCreative1 = () => {
  ...
  class="bg-websiteFocus px-6 py-10 text-complimentryTextColor border-y-4 border-black sm:px-10"
>
  <div
    ...
    {/* <!-- Article cards --> */}
    {
      articles.map((article) => (
        <a href="/">
          <article
            id="sq"
            class="border-2 border-r-4 border-black opacity-70 hover:opacity-100 relative min-h-[300px] min-w-[260px] overflow-hidden rounded-2xl shadow-2xl transition duration-300 hover:-translate-x-2"
          >
            <img
              src={article.image}
              alt=""
